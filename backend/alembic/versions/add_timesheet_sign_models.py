...
def upgrade():
    op.create_table(
        ...
        sa.Column('expires_at', sa.DateTime(), nullable=False, default=lambda: dt.utcnow() + timedelta(days=3)),
    ...
    op.create_table(
        ...
        sa.Column('signed_at', sa.DateTime(), nullable=False, default=lambda: dt.utcnow()),
    )
